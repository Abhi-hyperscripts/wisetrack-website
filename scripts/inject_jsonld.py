...
PAGE_META = {
    ...
    "blog.html":         ("Journal — WiseTrack", "Journal"),
    ...
    "hrms-payroll.html": ("Custom HRMS & Payroll — WiseTrack", "Custom HRMS"),
    "crm-sales.html":    ("Custom CRM & Sales — WiseTrack", "Custom CRM"),
    "custom-services.html": ("Custom Engineering & Software Services — WiseTrack", "Services"),
